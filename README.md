...
<p align="center">
  <img
    src="https://readme-typing-svg.demolab.com/?font=Montserrat&weight=600&size=19&duration=3500&pause=1200&color=B8844F&center=true&vCenter=true&repeat=true&random=false&width=900&height=70&lines=Dados+que+transformam+representatividade+em+decis%C3%A3o;12+marcas+%7C+23+linhas+de+produtos+%7C+175+tonalidades;Python+%2B+Power+BI+%2B+Storytelling+%2B+Impacto+Social"
...
<a href="./assets/aurena-logo.png">
  <img
    src="./assets/aurena-logo.png"
    alt="Identidade visual da marca Aurena"
    width="420"
  >
</a>
...
flowchart LR
    ...
    classDef problema fill:#2F1E1A,stroke:#B8844F,color:#FCF8F3,stroke-width:2px;
    classDef analise fill:#6F3B46,stroke:#C78F62,color:#FCF8F3,stroke-width:2px;
    classDef oportunidade fill:#A65F46,stroke:#F3E7D8,color:#FCF8F3,stroke-width:2px;

    class A problema;
    class B,C analise;
    class D oportunidade;
...
<img src="./assets/hero-beleza-sem-lacunas.png" width="100%" alt="Painel editorial sobre profundidade, subtom, acesso e evidência">
...
<img src="https://img.shields.io/badge/BASE-2F1E1A?style=for-the-badge" alt="Base">
<img src="https://img.shields.io/badge/CORRETIVO-B8844F?style=for-the-badge" alt="Corretivo">
<img src="https://img.shields.io/badge/SKIN%20TINT-A65F46?style=for-the-badge" alt="Skin Tint">
<img src="https://img.shields.io/badge/P%C3%93-C78F62?style=for-the-badge" alt="Pó">
<img src="https://img.shields.io/badge/TONS%20E%20SUBTONS-6F3B46?style=for-the-badge" alt="Tons e subtons">
...
flowchart TB
    ...
    classDef produtos fill:#3D2924,stroke:#B8844F,color:#FCF8F3,stroke-width:2px;
    classDef tons fill:#A65F46,stroke:#F3E7D8,color:#FCF8F3,stroke-width:2px;
    classDef fontes fill:#C78F62,stroke:#2F1E1A,color:#2F1E1A,stroke-width:2px;
...
flowchart LR
    ...
    classDef contexto fill:#2F1E1A,stroke:#B8844F,color:#FCF8F3,stroke-width:2px;
    classDef mercado fill:#6F3B46,stroke:#C78F62,color:#FCF8F3,stroke-width:2px;
    classDef oportunidade fill:#A65F46,stroke:#F3E7D8,color:#FCF8F3,stroke-width:2px;

    class A,B contexto;
    class C,D mercado;
    class E oportunidade;
...
```mermaid
flowchart TB
    P["CONTEXTO DO MERCADO<br/>Diversidade da população brasileira"]

    P --> A["ANÁLISE<br/>Tons, subtons, preços,<br/>estoques e evidências"]

    A --> L["LACUNAS<br/>Públicos, profundidades<br/>ou necessidades pouco atendidas"]

    L --> O["OPORTUNIDADE AURENA<br/>Desenvolvimento de uma proposta<br/>mais inclusiva e orientada por dados"]

    O --> V["GERAÇÃO DE VALOR<br/>Produto, posicionamento,<br/>comunicação e experiência"]
...
<img src="https://img.shields.io/badge/INVESTIGAR-2F1E1A?style=for-the-badge" alt="Investigar">
<img src="https://img.shields.io/badge/MEDIR-6F3B46?style=for-the-badge" alt="Medir">
<img src="https://img.shields.io/badge/INTERPRETAR-A65F46?style=for-the-badge" alt="Interpretar">
<img src="https://img.shields.io/badge/TRANSFORMAR-B8844F?style=for-the-badge" alt="Transformar">
...
flowchart TB
    ...
    classDef resultado fill:#A65F46,stroke:#F3E7D8,color:#FCF8F3,stroke-width:2px;

    class O central;
    class P,A,V,E movimento;
    class R,I,C,D resultado;
...
```mermaid
flowchart LR
    A["BASE<br/>ORGANIZADA"] --> B["DADOS<br/>TRATADOS"]
    B --> C["INDICADORES<br/>VALIDADOS"]
    C --> D["DASHBOARD<br/>INTERATIVO"]
    D --> E["INSIGHTS<br/>CONTEXTUALIZADOS"]
    E --> F["RECOMENDAÇÕES<br/>ESTRATÉGICAS"]

    classDef dados fill:#2F1E1A,stroke:#B8844F,color:#FCF8F3,stroke-width:2px;
    classDef analise fill:#6F3B46,stroke:#C78F62,color:#FCF8F3,stroke-width:2px;
    classDef impacto fill:#A65F46,stroke:#F3E7D8,color:#FCF8F3,stroke-width:2px;
...
flowchart LR
    ...
    classDef origem fill:#2F1E1A,stroke:#B8844F,color:#FCF8F3,stroke-width:2px;
    classDef classificacao fill:#6F3B46,stroke:#C78F62,color:#FCF8F3,stroke-width:2px;
    classDef analise fill:#3D2924,stroke:#B8844F,color:#FCF8F3,stroke-width:2px;
    classDef aprovado fill:#A65F46,stroke:#F3E7D8,color:#FCF8F3,stroke-width:2px;
    classDef restrito fill:#C78F62,stroke:#2F1E1A,color:#2F1E1A,stroke-width:2px;

    class A,B origem;
    class C,G classificacao;
    class D,E,F analise;
    class H aprovado;
    class I restrito;
...
```mermaid
flowchart TB
    A["REGISTRO COLETADO"] --> B{"A fonte está<br/>identificada?"}

    B -->|NÃO| C["REVISAR O REGISTRO"]
    B -->|SIM| D{"A natureza da informação<br/>está classificada?"}

    D -->|NÃO| C
    D -->|SIM| E{"O método está<br/>documentado?"}

    E -->|NÃO| C
    E -->|SIM| F{"A cobertura atinge<br/>pelo menos 75%?"}

    F -->|NÃO| G["MANTER APENAS<br/>PARA CONTEXTO"]
    F -->|SIM| H["LIBERAR PARA<br/>COMPARAÇÃO"]

    classDef inicio fill:#2F1E1A,stroke:#B8844F,color:#FCF8F3,stroke-width:2px;
    classDef decisao fill:#6F3B46,stroke:#C78F62,color:#FCF8F3,stroke-width:2px;
    classDef revisao fill:#C78F62,stroke:#2F1E1A,color:#2F1E1A,stroke-width:2px;
    classDef aprovado fill:#A65F46,stroke:#F3E7D8,color:#FCF8F3,stroke-width:2px;

    class A inicio;
    class B,D,E,F decisao;
    class C,G revisao;
    class H aprovado;
...
```mermaid
pie showData
    title Distribuição dos 100 pontos
    "Tons escuros ou retintos confirmados" : 35
    "Diversidade total da cartela" : 25
    "Diversidade de subtons" : 15
    "Posicionamento inclusivo" : 15
    "Acessibilidade de preço" : 10
```
...
```mermaid
erDiagram
    MARCAS ||--o{ LINHAS_PRODUTOS : possui
    LINHAS_PRODUTOS ||--o{ TONS_DETALHADOS : oferece
    LINHAS_PRODUTOS ||--o{ FONTES : documentada_por
    MARCAS ||--o{ FONTES : referenciada_por
    ...
    LINHAS_PRODUTOS {
        ...
        int quantidade_tons
        float cobertura_evidencia
        float indice_exploratorio
    }
...
flowchart LR
    ...
    classDef comunicacao fill:#A65F46,stroke:#F3E7D8,color:#FCF8F3,stroke-width:2px;

    class A,B,C dados;
    class D,E inteligencia;
    class F,G comunicacao;
...
<img src="https://img.shields.io/badge/Jupyter-B8844F?style=for-the-badge&logo=jupyter&logoColor=white" alt="Jupyter">
<img src="https://img.shields.io/badge/Power%20BI-2F1E1A?style=for-the-badge&logo=powerbi&logoColor=white" alt="Power BI">
<img src="https://img.shields.io/badge/Excel-6F3B46?style=for-the-badge&logo=microsoftexcel&logoColor=white" alt="Excel">
<img src="https://img.shields.io/badge/GitHub-A65F46?style=for-the-badge&logo=github&logoColor=white" alt="GitHub">
...
```mermaid
flowchart TB
    P["BELEZA SEM LACUNAS<br/>Equipe multidisciplinar"]

    P --> DS["DESIGN & STORYTELLING<br/>Identidade, narrativa e apresentação"]
    P --> PY["PYTHON & DADOS<br/>Tratamento, análise e validação"]
    P --> BI["POWER BI<br/>Modelagem, indicadores e visualizações"]

    DS --> C["CASSIANO<br/>Identidade visual, README e narrativa"]
    DS --> J["JU<br/>Pesquisa visual, composição e apresentação"]

    PY --> AD["ADRIELLE<br/>Limpeza, tratamento e análise exploratória"]
    PY --> K["KARLA<br/>Bases, validações e indicadores"]

    BI --> AN["ANA<br/>Modelagem, medidas e construção dos painéis"]
    BI --> W["WAANDERNILSON<br/>Visualizações, filtros e navegação"]

    classDef projeto fill:#2F1E1A,stroke:#B8844F,color:#FCF8F3,stroke-width:3px;
    classDef design fill:#6F3B46,stroke:#C78F62,color:#FCF8F3,stroke-width:2px;
    classDef dados fill:#3D2924,stroke:#B8844F,color:#FCF8F3,stroke-width:2px;
    classDef dashboard fill:#A65F46,stroke:#F3E7D8,color:#FCF8F3,stroke-width:2px;
    classDef integrante fill:#FCF8F3,stroke:#B8844F,color:#2F1E1A,stroke-width:1px;

    class P projeto;
    class DS design;
    class PY dados;
    class BI dashboard;
    class C,J,AD,K,AN,W integrante;
...
```mermaid
flowchart LR
    A["01 · PLANEJAMENTO<br/>Problema e objetivos"] --> B["02 · COLETA<br/>Marcas, produtos e fontes"]
    B --> C["03 · TRATAMENTO<br/>Limpeza e padronização"]
    C --> D["04 · ANÁLISE<br/>Indicadores e lacunas"]
    D --> E["05 · DASHBOARD<br/>Power BI"]
    E --> F["06 · STORYTELLING<br/>Narrativa e insights"]
    F --> G["07 · VALIDAÇÃO<br/>Revisão final"]
    G --> H["08 · APRESENTAÇÃO<br/>Entrega do projeto"]

    classDef concluido fill:#2F1E1A,stroke:#B8844F,color:#FCF8F3,stroke-width:2px;
    classDef andamento fill:#6F3B46,stroke:#C78F62,color:#FCF8F3,stroke-width:2px;
    classDef proximo fill:#A65F46,stroke:#F3E7D8,color:#FCF8F3,stroke-width:2px;

    class A,B concluido;
    class C,D,E,F andamento;
    class G,H proximo;
...
```mermaid
gantt
    title Roadmap final — Beleza sem Lacunas
    dateFormat YYYY-MM-DD
    axisFormat %d/%m

    section Dados
    Tratamento e padronização          :active, dados1, 2026-08-06, 4d
    Análise exploratória               :active, dados2, 2026-08-08, 4d
    Validação dos indicadores          :crit, dados3, 2026-08-12, 3d

    section Power BI
    Modelagem e medidas                :active, bi1, 2026-08-06, 5d
    Construção das visualizações       :active, bi2, 2026-08-09, 5d
    Testes de filtros e navegação      :crit, bi3, 2026-08-14, 2d

    section Design e storytelling
    Organização da narrativa           :active, design1, 2026-08-08, 5d
    Revisão visual do projeto          :design2, 2026-08-12, 4d
    Preparação da apresentação         :crit, design3, 2026-08-15, 2d

    section Entrega
    Fechamento interno                 :milestone, entrega1, 2026-08-16, 0d
    Ensaio e ajustes finais            :entrega2, 2026-08-17, 1d
    Apresentação final                 :milestone, entrega3, 2026-08-18, 0d
```
...
flowchart LR
    ...
    classDef origem fill:#2F1E1A,stroke:#B8844F,color:#FCF8F3,stroke-width:2px;
    classDef processamento fill:#6F3B46,stroke:#C78F62,color:#FCF8F3,stroke-width:2px;
    classDef entrega fill:#A65F46,stroke:#F3E7D8,color:#FCF8F3,stroke-width:2px;
    classDef visual fill:#3D2924,stroke:#C78F62,color:#FCF8F3,stroke-width:2px;

    class A origem;
    class B,C,D processamento;
    class E,F entrega;
    class G,H visual;
...
<p align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=waving&amp;color=0:B8844F,45:6F3B46,100:2F1E1A&amp;height=145&amp;section=footer&amp;text=AURENA&amp;fontSize=23&amp;fontColor=FCF8F3&amp;fontAlignY=72&amp;desc=A%20nova%20gera%C3%A7%C3%A3o%20da%20beleza%20come%C3%A7a%20em%20voc%C3%AA&amp;descAlignY=88&amp;descSize=13&amp;animation=twinkling" alt="Rodapé animado da Aurena">
</p>